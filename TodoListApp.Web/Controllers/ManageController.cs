...
namespace TodoListApp.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(TodoListAppUserManager userManager, TodoListAppSignInManager signInManager)
        {
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new AccountController.ChallengeResult(
                provider, 
                Url.Action("LinkLoginCallback", "Manage"), User.Identity.GetUserId<int>().ToString());
        }
